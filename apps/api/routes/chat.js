  ...
  router.get("/chat/room/:room", requireAuth, async (req, res) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[chat:room] Thread.markRead failed:",
          err?.message || err,
        );
      }
      ...
      try {
        ...
        const uids = [
          ...new Set(reversed.map((m) => m.fromUid).filter(Boolean)),
        ];
        ...
        console.warn(
          "[chat:room] sender enrichment failed:",
          err?.message || err,
        );
  ...
  router.get("/chat/with/:peerUid", requireAuth, async (req, res) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[chat:with] sender enrichment failed:",
          err?.message || err,
        );
  ...
  router.put("/chat/thread/:peerUid/read", requireAuth, async (req, res) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[chat:thread/read] Thread.markRead failed:",
          err?.message || err,
        );
      }
  ...
  router.put("/chat/room/:room/read", requireAuth, async (req, res) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[chat:room/read] Thread.markRead failed:",
          err?.message || err,
        );
      }
  ...
  router.post("/chat/room/:room/message", requireAuth, async (req, res) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[chat:post] Thread.touchLastMessage failed:",
          err?.message || err,
        );
      }
